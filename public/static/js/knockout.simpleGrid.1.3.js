/*
 * Downloaded from http://knockoutjs.com/examples/resources/knockout.simpleGrid.1.3.js, 2013-07-07 19:08
 */
...
(function () {
    ...
    ko.simpleGrid = {
        ...
        viewModel: function (configuration) {
            ...
            this.checkForSuccess = configuration.checkForSuccess || function() { return false;};
        }
    };
    ...
    templateEngine.addTemplate("ko_simpleGrid_grid", "\
                    <table class=\"ko-grid table table-striped table-condensed table-bordered\" cellspacing=\"0\">\
                        ...
                        <tbody data-bind=\"foreach: itemsOnCurrentPage\">\
                           <tr data-bind=\"foreach: $parent.columns, css: { success: $parent.checkForSuccess($data) }\">\
